...
{
    protected $fillable = ['project_id', 'quotation_item_id', 'material_id', 'item_name', 'quantity', 'unit', 'outgoing_quantity', 'outgoing_at', 'is_not_applicable', 'is_completed', 'completed_at', 'returned_quantity', 'returned_at'];
