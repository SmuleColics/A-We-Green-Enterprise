        ...
        <div class="auth-form-side">
            ...
            <div class="auth-form-center">
                <div class="auth-form-inner">
                    ...
                    <form class="mt-4" method="POST" action="{{ route('reset-password.update') }}" novalidate>
                        ...
                        <!-- Reset Code -->
                        <div class="mb-3">
                            <label for="code" class="form-label auth-label">Reset code</label>
                            <div class="input-icon-wrap">
                                <i class="bi bi-shield-lock input-icon"></i>
                                <input id="code" name="code" type="text" inputmode="numeric" maxlength="6"
                                    class="form-control auth-input ps-input @error('code') is-invalid @enderror"
                                    placeholder="6-digit code" value="{{ old('code') }}" required />
                            </div>
                            @error('code')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-icon-wrap">
                                ...
                                <input id="password" name="password" type="password"
                                    class="form-control auth-input ps-input pe-input @error('password') is-invalid @enderror"
