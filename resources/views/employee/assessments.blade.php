...
@section('topbar-actions')
    <a href="{{ route('employee.requests') }}" class="btn btn-sm btn-light fw-semibold d-flex align-items-center green-text">
                                ...
                                @foreach ($assessments as $a)
                                    ...
                                    zip: {{ Js::from($client->zip_code ?? '—') }}
                                            ...
                                            @if ($a->derived_status === 'Done Assessment' || $a->derived_status === 'Submitted Form')
                                                <a href="{{ route('employee.assessments.form.show', $a) }}"
                                            ...
                                            @if ($a->assessment_form_completed_at)
                                                <a target="_blank" href="{{ route('employee.assessments.form.print', $a) }}"
