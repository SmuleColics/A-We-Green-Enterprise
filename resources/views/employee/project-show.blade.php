...
@section('topbar-actions')
    <a href="{{ route('employee.projects') }}" class="btn btn-sm btn-outline-light d-flex align-items-center gap-1">
    ...
    <div class="container-fluid px-4 py-4">
        ...
        <div class="detail-card mb-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                @endif
                <a href="{{ route('employee.assessments.form.show', $quotation->assessment) }}"
                    class="btn btn-sm btn-outline-secondary d-flex align-items-center gap-1">
                ...
                <a href="{{ route('employee.checklists.show', $project) }}"
                    class="btn btn-sm btn-outline-secondary d-flex align-items-center gap-1">
        ...
        <div class="tab-pane fade" id="tasksSection" role="tabpanel" aria-labelledby="tasks-tab">
            <div class="detail-card">
                ...
                @if ($assignedEmployees->isEmpty())
                    <p class="text-muted small fst-italic mb-0">No employees assigned yet.</p>
                @else
                    <div class="d-flex flex-wrap gap-2">
                ...
                <h6 class="fw-semibold mt-4 mb-3 pt-3 border-top d-flex align-items-center gap-2">
