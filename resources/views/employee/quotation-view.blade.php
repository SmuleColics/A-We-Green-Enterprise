...
@section('topbar-actions')
    <a href="{{ route('employee.quotations') }}" class="btn btn-sm btn-outline-light fw-semibold d-flex align-items-center gap-1"><span class="material-symbols-outlined fs-17">arrow_back</span>Back to Quotations</a>
@endsection
@section('content')
<div class="container-fluid px-4 py-4"><div class="quotation-form-wrap mx-auto">
    ...
    @elseif ($quotation->status === 'Approved' && $quotation->project)
        <div class="alert alert-success d-flex align-items-start gap-2 mb-4">
            ...
            <p class="mb-0 small">The client approved this quotation and the contract has been confirmed.
                Project {{ $quotation->project->reference_number }}.
            </p>
        </div>
    @elseif ($quotation->status === 'Approved')
        <div class="alert alert-success d-flex align-items-start gap-2 mb-4"><span
                ...
                this quotation. The contract is pending upload by the admin team.</p></div>
    @else
        <div class="alert alert-success d-flex align-items-start gap-2 mb-4"><span
    ...
    <div class="d-flex justify-content-between align-items-center pb-5"><a href="{{ route('employee.assessments.form.show', $quotation->assessment) }}" class="btn btn-outline-secondary">View Assessment</a><div class="d-flex gap-2"><a target="_blank" href="{{ route('employee.quotations.print', $quotation) }}" class="btn btn-outline-secondary">Preview PDF</a><button type="button" class="btn
